    ...
    <section class="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden hero-gradient hero-pattern">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
                ...
                <!-- POS Mockup Image Section (Updated for TC-38: Added fallback and lazy loading) -->
                <div class="relative lg:h-[600px] w-full flex items-center justify-center fade-in-up" style="animation-delay: 0.3s;">
                    <div class="relative w-full max-w-lg z-20">
                        <img 
                            ...
                            loading="lazy"
                            onerror="this.onerror=null; this.src='https://placehold.co/600x400/e2e8f0/1e293b?text=POS+System+Preview';"
                            class="rounded-2xl shadow-2xl border border-slate-100 transform rotate-y-12 hover:rotate-0 transition duration-700 ease-out w-full ring-1 ring-slate-900/5 bg-slate-50"
                        >
